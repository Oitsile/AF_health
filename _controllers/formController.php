...
class formController extends App
{
    ...
    public function step_1() {
        ...
        $data['src_id'] = $inoCode;
        $data['lead_src_reference'] = $inoName;
...
//         die;
    ...
    public function step_3() {
        ...
        $mysqli = $this->conn();
        // insert into health
        $query = "INSERT INTO health (`lead_source`, `sale_completed`, `sales_agent`, `abn_agent`, `package`, `termination`, `status`, `any_other_plan`, `any_plan_cancelled`, `cancel_reason`, `replacing`, `replacing_reason`, `language`, `first_debit`, `activation_date`, `activation_reason`, `group`, `clanguage`, `bitco` , `referred`) VALUES ('$lead_id', '$saledate', 257, '$inoCode', '$coverselector', '2099-12-31', 304, '', '', '', '', '', '$language', '', '', 0, 0, '$language', 1 , 'WS SALE')";
        $mysqli->query($query);
